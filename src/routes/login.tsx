...
function LoginPage() {
  ...
  return (
    <div className="flex min-h-[75vh] items-center justify-center px-4 py-8">
      <Card className="w-full max-w-lg p-6 sm:p-8 space-y-6 shadow-2xl border-border bg-card/95 backdrop-blur-sm rounded-xl transition-all">
        {/* Header */}
        <div className="text-center space-y-2">
          <div className="mx-auto flex size-12 items-center justify-center rounded-full bg-primary/10 text-primary shadow-sm ring-1 ring-primary/20">
        ...
        >
          <TabsList className="grid w-full grid-cols-4 h-10 p-1 bg-muted/60 rounded-lg">
            ...
            <TabsTrigger value="magic" className="text-xs font-medium">
              Magic Link
            </TabsTrigger>
            <TabsTrigger value="forgot" className="text-xs font-medium">
              Reset
            </TabsTrigger>
          </TabsList>
          ...
          {/* Error Banner */}
          {error && (
            <div role="alert" className="mt-4 p-3 text-xs text-destructive bg-destructive/10 border border-destructive/20 rounded-md">
              {error}
            </div>
          )}
        ...
        {/* Security Badge */}
        <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground bg-muted/30 p-3 rounded-md border border-border/50">
